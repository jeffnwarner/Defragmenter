...
/* 3*/      while( array[ currentPos ].info != EMPTY &&
                   array[ currentPos ].element.original != x.original )
            {
...
/* 7*/      return currentPos;
        ...
        */
        ...
        /*
         * A hash routine for HashedObj of type DiskBlock_Number
         */
        template <class HashedObj>
        int QuadraticHashTable<HashedObj>::hash( const HashedObj &x, int tableSize ) const
        {
            return x.original % tableSize;
        }